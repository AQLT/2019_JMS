...
La bonne utilisation de ces modèles demande aussi un peu\dots{} de bon sens. Ainsi, et à titre d'exemple, il est certainement absurde d'essayer d'estimer correctement un effet d'année bissextile avec un modèle sur une série de moins de 9 ans. Pour estimer cet effet, vous n'aurez alors observé que deux années bissextiles, ce qui est bien peu.
